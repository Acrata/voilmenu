...
gulp.task( 'wp-pot', [ 'clean:pot' ], () =>
	gulp.src( paths.php )
		...
		.pipe( wpPot( {
			'domain': 'menu_test',
			'destFile': 'menu_test.pot',
			'package': 'menu_test',
			'bugReport': 'https://webdevstudios.com/',
			'lastTranslator': 'Hector Ovalles <hxtr227@gmail.com>',
			'team': 'Team <hxtr227@gmail.com>'
		} ) )
...
gulp.task( 'watch', function () {
	...
	browserSync( {
		...
		'proxy': 'http://localhost/wdmenu',    // Use https://webdevstudios.com/:3000 to use BrowserSync.
		'watchOptions': {
